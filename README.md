# Angular Boot Camp example: animations
...
**[StackBlitz for animations](https://stackblitz.io/github/AngularBootCamp/animations)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/animations.git
cd animations
npm install
npm start
```
